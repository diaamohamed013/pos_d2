var Akademi = function() {
    ...
    var t = function() {
      ...
      , h = function() {
        ...
        setTimeout(()=>{
            1400 >= $(window).width() ? jQuery(".wallet-open").removeClass("active") : jQuery(".wallet-open").addClass("active")
        }
        , 500)
    }
      , m = function() {
        $(".btn-number").on("click", function(e) {
            ...
            var t = $("input[name='" + fieldName + "']")
              , a = parseInt(t.val());
            isNaN(a) ? t.val(0) : "minus" == type ? t.val(a - 1) : "plus" == type && t.val(a + 1)
        })
    }
      , f = function() {
      ...
      , C = function() {
        jQuery("#lightgallery ,#lightgallery-2").length > 0 && $("#lightgallery ,#lightgallery-2").lightGallery({
            loop: !0,
            thumbnail: !0,
      ...
      , k = function() {
        jQuery("#lightgallery-1").length > 0 && $("#lightgallery-1").lightGallery({
            loop: !0,
            thumbnail: !0,
            exThumbImage: "data-exthumbimage"
        })
      ...
      , y = function() {
        jQuery(".dlab-demo-content").length > 0 && (new PerfectScrollbar(".dlab-demo-content"),
      ...
      , q = function() {
        if (jQuery(".image-select").length > 0) {
            ...
            e.find("option").each((e,t)=>{
                ...
                n && a.attr("data-content", "<img src='%i'/> %s".replace(/%i/, n).replace(/%s/, a.text()))
            }
            ),
            e.selectpicker()
        }
      ...
      , T = function() {
        jQuery(".dz-theme-mode").on("click", function() {
            jQuery(this).toggleClass("active"),
            jQuery(this).hasClass("active") ? jQuery("body").attr("data-theme-version", "dark") : jQuery("body").attr("data-theme-version", "light")
        })
    }
      , D = function() {
        ...
        if (jQuery(".navbar-nav").length > 0) {
            ...
            jQuery(document).on("scroll", function() {
                ...
                jQuery(".navbar-nav .scroll").each(function() {
                    ...
                    void 0 != jQuery(this.hash).offset())
                        var n = parseInt(jQuery(this.hash).offset().top, 10);
                    else
                        var n = 0;
                    n - t <= e && (a.parent().addClass("active"),

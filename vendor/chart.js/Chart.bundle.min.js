 ...
 */
    ...
    class V {
        constructor(t) {
            ...
            let i;
            var s, n, o;
            "object" === e ? i = F(t) : "string" === e && (o = (s = t).length,
            "#" === s[0] && (4 === o || 5 === o ? n = {
                r: 255 & 17 * f[s[1]],
                g: 255 & 17 * f[s[2]],
                b: 255 & 17 * f[s[3]],
    ...
    function Be(t, e, i, s) {
        ...
        return null !== l && ((!ut(o) || o === i || (l = Ve(r, a, o, l, s),
        null !== l)) && Oe(Array.from(r), [""], n, o, (()=>function(t, e, i) {
    ...
    function Xe(t, e="x") {
        ...
        !function(t, e, i) {
            ...
            for (let c = 0; c < s - 1; ++c)
                l = h,
                h = $e(t, c + 1),
                l && h && (Ht(e[c], 0, je) ? i[c] = i[c + 1] = 0 : (n = i[c] / e[c],
                o = i[c + 1] / e[c],
    ...
    function Ke(t, e, i, s, n) {
        ...
        e.capBezierPoints && function(t, e) {
            ...
            s = t.length; i < s; ++i)
                ...
                r = i < s - 1 && ve(t[i + 1], e),
                o && (n = t[i],
                a && (n.cp1x = qe(n.cp1x, e.left, e.right),
                n.cp1y = qe(n.cp1y, e.top, e.bottom)),
                r && (n.cp2x = qe(n.cp2x, e.left, e.right),
    ...
    function ui(t, e) {
        ...
        s && !("" + s).match(ai) && (console.warn('Invalid font style specified: "' + s + '"'),
        s = "");
        const n = {
    ...
    function Ui(t, e, i, s) {
        ...
        for (const r of t) {
            ...
            if (r.horizontal) {
                ...
                t.fullSize ? Yi(t, n.left, a, i.outerWidth - n.right - n.left, o) : Yi(t, e.left + l.placed, a, s, o),
                l.start = a,
                l.placed += s,
                a = t.bottom
            } else {
                ...
                t.fullSize ? Yi(t, o, n.top, a, i.outerHeight - n.bottom - n.top) : Yi(t, o, e.top + l.placed, a, s),
                l.start = o,
                l.placed += s,
                o = t.right
            }
    ...
    function es(t, e, i) {
        const s = t.canvas
          , n = new MutationObserver((t=>{
            let e = !1;
            for (const i of t)
                e = e || ts(i.addedNodes, s),
                e = e && !ts(i.removedNodes, s);
            e && i()
        }
        ));
    ...
    function as(t, i, s) {
        ...
        return r.observe(o),
        function(t, e) {
            ss.size || window.addEventListener("resize", os),
            ss.set(t, e)
        }(t, a),
        r
    }
    function rs(t, e, i) {
        ...
        "resize" === e && function(t) {
            ss.delete(t),
            ss.size || window.removeEventListener("resize", os)
        }(t)
    }
    function ls(t, i, s) {
        const n = t.canvas
    ...
    class ms {
        ...
        _createAnimations(t, e) {
            ...
            for (r = o.length - 1; r >= 0; --r) {
                ...
                d && d.duration ? (n[l] = c = new gs(d,t,l,h),
                s.push(c)) : t[l] = h
            }
            return s
        }
    ...
    class Cs {
        ...
        updateIndex(t) {
            this.index !== t && Ss(this._cachedMeta),
            this.index = t
        }
        linkScales() {
            const t = this.chart
        ...
        updateRangeFromParsed(t, e, i, s) {
            ...
            s && a && (s.values = a,
            o = _s(s, n, this._cachedMeta.index)),
    ...
    function Ls(t, e) {
        ...
        if (o > 0) {
            ...
            for (Rs(e, l, h, U(s) ? 0 : a - s, a),
            t = 0,
            i = o - 1; t < i; t++)
                Rs(e, l, h, n[t], n[t + 1]);
            return Rs(e, l, h, r, U(s) ? e.length : r + s),
            l
        }
        return Rs(e, l, h),
        l
    ...
    class Ns extends Os {
        ...
        getUserBounds() {
            ...
            return t = G(t, Number.POSITIVE_INFINITY),
        ...
        update(t, e, i) {
            ...
            o.display && (o.autoSkip || "auto" === o.source) && (this.ticks = Ls(this, this.ticks),
            this._labelSizes = null,
            this.afterAutoSkip()),
        ...
        generateTickLabels(t) {
            ...
            s = t.length; i < s; i++)
                n = t[i],
                n.label = tt(e.callback, [n.value, i, t], this)
        }
        ...
        calculateLabelRotation() {
            ...
            a = this.maxHeight - Fs(t.grid) - e.padding - Bs(t.title, this.chart.options.font),
            r = Math.sqrt(c * c + d * d),
        ...
        fit() {
            ...
            if (o) {
                ...
                t.height = Fs(n) + o) : (t.height = this.maxHeight,
                t.width = Fs(n) + o),
            ...
            for (a = 0; a < e; ++a) {
                ...
                U(h) || X(h)) {
                    if (X(h))
                        ...
                        l = h.length; r < l; ++r)
                            m = h[r],
                            U(m) || X(m) || (g = me(i, u.data, u.gc, g, m),
                            p += f)
                } else
                    g = me(i, u.data, u.gc, g, h),
                    p = f;
                n.push(g),
                o.push(p),
                b = Math.max(g, b),
        ...
        drawBorder() {
            ...
            const o = i.setContext(this.getContext(0)).lineWidth
              , a = this._borderValue;
            let r, l, h, c;
            this.isHorizontal() ? (r = xe(t, this.left, n) - n / 2,
            l = xe(t, this.right, o) + o / 2,
            h = c = a) : (h = xe(t, this.top, n) - n / 2,
        ...
        drawTitle() {
            ...
            "bottom" === e || "center" === e || q(e) ? (l += a.bottom,
            X(i.text) && (l += o.lineHeight * (i.text.length - 1))) : l += a.top;
    ...
    class Ws {
        ...
        unregister(t) {
            const e = this.items
              ...
              , s = this.scope;
            i in e && delete e[i],
            s && i in yt[s] && (delete yt[s][i],
            this.override && delete mt[i])
        }
    }
    var Hs = new class {
        constructor() {
    ...
    class js {
        ...
        _notify(t, e, i, s) {
            ...
            for (const n of t) {
                const t = n.plugin;
                if (!1 === tt(t[i], [e, s, n.options], t) && s.cancelable)
                    return !1
            }
            return !0
        }
        invalidate() {
            U(this._cache) || (this._oldCache = this._cache,
            this._cache = void 0)
        }
        _descriptors(t) {
            if (this._cache)
    ...
    class tn {
        ...
        datasetAnimationScopeKeys(t, e) {
            return Js(`${t}.transition.${e}`, (()=>[[`datasets.${t}.transitions.${e}`, `transitions.${e}`], [`datasets.${t}`, ""]]))
        }
        datasetElementScopeKeys(t, e) {
            return Js(`${t}-${e}`, (()=>[[`datasets.${t}.elements.${e}`, `datasets.${t}`, `elements.${e}`, ""]]))
        }
        pluginScopeKeys(t) {
            const e = t.id;
    ...
    function hn(t) {
        return ie() && "string" == typeof t ? t = document.getElementById(t) : t && t.length && (t = t[0]),
    ...
    class fn {
        ...
        _initialize() {
            ...
            this.options.responsive ? this.resize() : ue(this, this.options.devicePixelRatio),
            this.bindEvents(),
            this.notifyPlugins("afterInit"),
            this
        }
        clear() {
            return _e(this.canvas, this.ctx),
            this
        }
        stop() {
            return a.stop(this),
        ...
        _resize(t, e) {
            ...
            this._aspectRatio = this.aspectRatio,
            ue(this, a, !0) && (this.notifyPlugins("resize", {
                size: o
            }),
        ...
        buildOrUpdateScales() {
            ...
            et(n, (e=>{
                const n = e.options
                  ...
                  , a = Xs(o, n)
                  , r = Z(n.type, e.dtype);
                void 0 !== n.position && on(n.position, a) === on(e.dposition) || (n.position = e.dposition),
                s[o] = !0;
                let l = null;
        ...
        _checkEventBindings() {
            const t = this.options
              ...
              , i = new Set(t.events);
            gt(e, i) && !!this._responsiveListeners === t.responsive || (this.unbindEvents(),
            this.bindEvents())
        }
    ...
    function _n(t) {
        ...
        const l = ()=>{
            32767 !== o && -32768 !== o && (ut(a) && (r = Math.min(r, Math.abs(o - a) || r)),
            a = o)
        }
        ;
        for (s = 0,
    ...
    function Mn(t, e, i, s) {
        ...
        (i._top || 0) === s ? n = h : (i._bottom || 0) === s ? n = c : (o[kn(c, a, r, l)] = !0,
        n = h)),
        o[kn(n, a, r, l)] = !0,
        t.borderSkipped = o
    }
    function kn(t, e, i, s) {
        var n, o, a;
        return s ? (a = i,
        t = Sn(t = (n = t) === (o = e) ? a : n === a ? o : n, i, e)) : t = Sn(t, e, i),
        t
    }
    function Sn(t, e, i) {
            ...
            if (e.grouped) {
                const i = n ? this._getStackCount(t) : e.stackCount
                  , l = "flex" === s.barThickness ? function(t, e, i, s) {
                    ...
                    let o, a;
                    return U(n) ? (o = e.min * i.categoryPercentage,
        ...
        update(t) {
            ...
            let {start: a, count: r} = function(t, e, i) {
                ...
                if (t._sorted) {
                    ...
                    d && (n = Qt(Math.min(wt(r, a.axis, h).lo, i ? s : wt(e, l, a.getPixelForValue(h)).lo), 0, s - 1)),
                    o = u ? Qt(Math.max(wt(r, a.axis, c).hi + 1, i ? 0 : wt(e, l, a.getPixelForValue(c)).hi + 1), n, s) - n : s - n
                }
                return {
                    start: n,
                    count: o
    ...
    function zn(t, e, i) {
        ...
        t.arc(o, a, r, s - h, i + h),
        l > n ? (h = n / l,
        t.arc(o, a, l, i + h, s - h, !0)) : t.arc(o, a, n, i + Et, s - Et),
        t.closePath(),
        t.clip()
    }
    function Fn(t, e, i, s) {
    ...
    function Vn(t, e, i, s, n) {
        ...
        const g = (f - Math.max(.001, f * c - i / Ot) / c) / 2
          , p = r + g + u
          , m = n - g - u
          , {outerStart: b, outerEnd: x, innerStart: _, innerEnd: y} = Fn(e, d, c, m - p)
          , v = c - b
          , w = c - x
          , M = p + b / v
          , k = m - x / w
    ...
    class Jn extends Os {
        ...
        draw(t, e) {
            const i = this.options;
            this.skip || i.radius < .1 || !ve(this, e, this.size(i) / 2) || (t.strokeStyle = i.borderColor,
        ...
        beforeElementsUpdate: (t,e,i)=>{
            ...
            t.data.datasets.forEach(((e,n)=>{
                ...
                let {start: c, count: d} = function(t, e) {
                    ...
                    return l && (n = Qt(wt(e, o.axis, a).lo, 0, i - 1)),
        ...
        const n = function(t) {
            if ((t.scale || {}).getPointPositionForValue)
                return function(t) {
                    const {scale: e, fill: i} = t
                      ...
                      , a = function(t, e, i) {
                        let s;
                        return s = "start" === t ? i : "end" === t ? e.options.reverse ? e.min : e.max : q(t) ? t.value : e.getBaseValue(),
                        s
                    }(i, e, o)
                      , r = [];
                    if (s.grid.circular) {
            ...
            return function(t) {
                const {scale: e={}, fill: i} = t
                  , s = function(t, e) {
                    let i = null;
                    return "start" === t ? i = e.bottom : "end" === t ? i = e.top : q(t) ? i = e.getPixelForValue(t.value) : e.getBasePixel && (i = e.getBasePixel()),
                    i
                }(i, e);
                if (K(s)) {
    ...
    function vo(t, e, i) {
        ...
        s && n.points.length && (we(t, i),
        function(t, e) {
            const {line: i, target: s, above: n, below: o, area: a, scale: r} = e
              , l = i._loop ? "angle" : e.axis;
            t.save(),
            "x" === l && o !== n && (wo(t, s, a.top),
            Mo(t, {
                line: i,
                target: s,
                color: n,
        ...
        _draw() {
            ...
            this.legendItems.forEach(((w,M)=>{
                ...
                !function(t, e, i) {
                    ...
                    if (s.fillStyle = Z(i.fillStyle, l),
                    ...
                    r.usePointStyle) {
                        ...
                        const o = e + Math.max((f - b) / 2, 0)
                          ...
                          , r = ci(i.borderRadius);
                        s.beginPath(),
                        Object.values(r).some((t=>0 !== t)) ? Ce(s, {
                            x: a,
                            y: o,
                            w: m,
                            h: b,
    ...
    function Io(t, e) {
        return e && (X(e) ? Array.prototype.push.apply(t, e) : t.push(e)),
        t
    }
    function zo(t) {
    ...
    class Yo extends Os {
        ...
        drawTitle(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = Ho(this, i.titleAlign, i),
        ...
        drawFooter(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = Ho(this, i.footerAlign, i),
        ...
        drawBackground(t, e, i, s) {
            const {xAlign: n, yAlign: o} = this
              , {x: a, y: r} = t
              , {width: l, height: h} = i
              , {topLeft: c, topRight: d, bottomLeft: u, bottomRight: f} = ci(s.cornerRadius);
    ...
    class Zo extends Ns {
        ...
        buildTicks() {
            ...
            const s = function(t, e) {
                ...
                w = p),
                m && b && n && jt((a - o) / n, k / 1e3) ? (M = Math.round(Math.min((a - o) / k, h)),
                k = (a - o) / M,
                v = o,
                w = a) : x ? (v = m ? o : v,
                w = b ? a : w,
                M = l - 1,
                k = (w - v) / M) : (M = (w - v) / k,
                M = Ht(M, Math.round(M), k / 1e3) ? Math.round(M) : Math.ceil(M));
                ...
                v < o && P++,
                Ht(Math.round((v + P * k) * y) / y, o, Go(o, _, t)) && P++) : v < o && P++); P < M; ++P)
                    i.push({
            ...
            return "ticks" === t.bounds && $t(s, this, "value"),
            t.reverse ? (s.reverse(),
            this.start = this.max,
    ...
    class ta extends Ns {
        ...
        buildTicks() {
            ...
            return "ticks" === t.bounds && $t(e, this, "value"),
            t.reverse ? (e.reverse(),
            this.start = this.max,
            this.end = this.min) : (this.start = this.min,
            this.end = this.max),
        ...
        getPixelForValue(t) {
            ...
            null === t || isNaN(t) ? NaN : this.getPixelForDecimal(t === this.min ? 0 : (Ft(t) - this._startValue) / this._valueRange)
        }
        getValueForPixel(t) {
    ...
    function la(t, e, i, s) {
        const {ctx: n} = t;
        if (i)
            n.arc(t.xCenter, t.yCenter, e, 0, At);
        else {
    ...
    class ha extends Zo {
        ...
        drawBackground() {
            ...
            if (t) {
                ...
                i.save(),
                i.beginPath(),
                la(this, this.getDistanceFromCenterForValue(this._endValue), e, this._pointLabels.length),
                i.closePath(),
                i.fillStyle = t,
                i.fill(),
                i.restore()
    ...
    function fa(t, e) {
        ...
        null === a ? null : (n && (a = "week" !== n || !Wt(o) && !0 !== o ? i.startOf(a, n) : i.startOf(a, "isoWeek", o)),
        +a)
    }
    function ga(t, e, i, s) {
        const n = da.length;
    ...
    function xa(t, e, i) {
        ...
        i ? (e >= t[r].pos && e <= t[l].pos && ({lo: r, hi: l} = wt(t, "pos", e)),
        ({pos: s, time: o} = t[r]),
        ({pos: n, time: a} = t[l])) : (e >= t[r].time && e <= t[l].time && ({lo: r, hi: l} = wt(t, "time", e)),
        ({time: s, pos: o} = t[r]),
        ({time: n, pos: a} = t[l]));
        const h = n - s;
    ...
    return fn.register(In, ya, ao, Xo),
    fn.helpers = {
        ...Di
    },
    fn._adapters = xn,
